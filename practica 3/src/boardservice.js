...
addPost("primeros", { title: "Almejas", img:"https://www.laflordegalicia.es/images/blog/almejas-a-la-marinera-L.jpg", ingredients:"levadura, huevos, vino, atun, pimientos", text:"La empanada gallega consiste en una masa parecida al pan con un relleno que puede variar, aunque generalmente suele ser de atún con pimientos y cebolla", price:"10",category: "primeros"});
addPost("primeros", { title: "empanada", img:"https://www.guiarepsol.com/content/dam/repsol-guia/contenidos-imagenes/comer/de-tapeo/ruta-empanada-santiago-compostela-la-radio-solleiros-abastos/gr-cms-media-featured_images-none-213ef37f-f233-4378-9a09-6042b491e436-02-alf_8438.jpg.transform/rp-rendition-lg/image.jpg", ingredients:"Pimientos de temporada, sal, aceite", text:"Pimientos del padron tipico de galicia", price:"9",category: "primeros"});
addPost("primeros", { title: "Pimientos del padron", img:"https://www.tuscasasrurales.com/blog/wp-content/uploads/2019/12/Pimientos-de-Padron.jpg", ingredients:"garbanzos, fideos, compagno", text:"Cocido tipico gallego", price:"22",category: "primeros"});
...
addPost("postres", { title: "Paparajotes", img: "https://i.blogs.es/902777/paparajotes/840_560.jpg", ingredientes:"limon, harina,  huevos, azucaar", text: "postres dulce tradicional de España", price:"7", category:"postre"});
